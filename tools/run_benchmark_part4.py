...
DEFAULT_BENCHMARK = ROOT / "benchmark" / "adaptive_memory_engine_benchmark_part4_multihop_reasoning.md"
DEFAULT_PRD = ROOT / "adaptive_memory_engine_prd_v2_2_integrated.md"
DEFAULT_MEMORY_MINI = ROOT / "tests" / "fixtures" / "memory-mini" / "docs"
DEFAULT_OUT = ROOT / "tests" / "out" / "sprint-4"


def main() -> None:
    parser = argparse.ArgumentParser(description="Run Part 4 Multi-Hop benchmark.")
    ...
    parser.add_argument("--corpus-id", default="benchmark-part4")
        ...
        questions.append(
            {
                ...
                "question": multiline_value(block, "Question"),
...
def multiline_value(block: str, label: str) -> str:
